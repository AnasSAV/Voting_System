function submitVote(teamName, pageNumber) {
    ...
    voteButton.textContent = 'Submitting...'; // Change text to indicate submission
...
// Enable the vote buttons again on page load
window.onload = function() {
    const voteButtons = document.querySelectorAll('button[data-team]');
    voteButtons.forEach(button => {
        button.disabled = false;  // Enable all buttons when the page reloads
    });
}
